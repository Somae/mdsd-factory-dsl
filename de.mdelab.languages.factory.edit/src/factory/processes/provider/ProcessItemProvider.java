...
/**
 * This is the item provider adapter for a {@link factory.processes.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends IdentifiedElementItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessesPackage.Literals.PROCESS__OWNED_TASKS);
		}
    ...
    public String getText(Object object) {
		String label = ((factory.processes.Process)object).getName();
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(factory.processes.Process.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProcessesPackage.Literals.PROCESS__OWNED_TASKS,
				 ProcessesFactory.eINSTANCE.createTask()));
	}
