...
/**
 * This is the item provider adapter for a {@link factory.Machine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MachineItemProvider extends IdentifiedElementItemProvider {
    /**
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Machine_x_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Machine_x_feature", "_UI_Machine_type"),
                 FactoryPackage.Literals.MACHINE__X,
                 true,
                 false,
                 false,
    ...
    protected void addYPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Machine_y_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Machine_y_feature", "_UI_Machine_type"),
                 FactoryPackage.Literals.MACHINE__Y,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
    ...
    protected void addDimensionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Machine_dimension_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Machine_dimension_feature", "_UI_Machine_type"),
                 FactoryPackage.Literals.MACHINE__DIMENSION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
